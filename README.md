...
- `isAddedToCart` - Проверяет, добавлен ли товар в корзину. Если товар из карточки уже присутствует в корзине (по совпадению id), то возвращает true, иначе — false.
Принимает необязательный параметр product типа Product
---
