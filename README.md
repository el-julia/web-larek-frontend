...
Сообщает всем подписчикам, что товары пришли с сервера и наш каталог товаров изменился
Не емеет полей, не имеет конструктора
...
Реализиует хранение товаров и управление товарами в корзине.
